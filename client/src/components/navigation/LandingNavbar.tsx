...
const LandingNavbar = () => {
  return (
    <div className='text-sm sticky hidden sm:flex top-28 p-2 mt-4 mb-2 sm:rounded-sm bg-slate-50  justify-between items-center text-neutral-500 bg-opacity-80  backdrop-blur-sm z-50 '>
